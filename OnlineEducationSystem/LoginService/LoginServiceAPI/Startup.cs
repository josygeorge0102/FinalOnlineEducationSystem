...
System.Console.WriteLine(Configuration["ConnectionStrings:LoginServiceDB"]);

services.AddDbContext<ApplicationDbContext>(options =>
   options.UseSqlServer(Configuration["ConnectionStrings:LoginServiceDB"]));
//    options.UseSqlServer(builder.Configuration["ConnectionStrings:LoginServiceDB"]));
            ...
            var builder = services.AddIdentityServer(options =>
            {
                ...
                .AddConfigurationStore(options =>
                {
                    ...
                    options.ConfigureDbContext = builder => 
                        builder.UseSqlServer(Configuration["ConnectionStrings:LoginServiceDB"]
